            ...
            <div className="space-y-5 sm:space-y-6">
              ...
              <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-xs border border-slate-200/80 dark:border-slate-800 p-5 sm:p-7 lg:p-8 space-y-6">
                ...
                {filteredUnifiedRows.length > 0 ? (
                  <>
                    <div className="hidden md:block my-8 sm:my-10 overflow-hidden rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xs">
                    ...
                    <div className="overflow-x-auto">
                      ...
                      <thead>
                        <tr className="bg-slate-50 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-800 text-xs font-bold text-slate-500 uppercase tracking-wider">
                          ...
                          {visibleColumns.storeBranch && <th className="py-4.5 sm:py-5 px-6">{isKhmer ? 'សាខាហាង' : 'Store Branch'}</th>}
                          {visibleColumns.location && <th className="py-4.5 sm:py-5 px-6">{isKhmer ? 'ទីតាំង / អាសយដ្ឋាន' : 'Location / Address'}</th>}
                          {visibleColumns.soundboxDevice && <th className="py-4.5 sm:py-5 px-6">{isKhmer ? 'ឧបករណ៍ Soundbox' : 'Soundbox Device'}</th>}
                          {visibleColumns.deviceType && <th className="py-4.5 sm:py-5 px-6">{isKhmer ? 'ប្រភេទឧបករណ៍' : 'Device Type'}</th>}
                          {visibleColumns.battery && <th className="py-4.5 sm:py-5 px-6">{isKhmer ? 'ថាមពលថ្ម' : 'Battery Level'}</th>}
                          {visibleColumns.signal && <th className="py-4.5 sm:py-5 px-6">{isKhmer ? 'កម្រិតសេវា' : 'Signal'}</th>}
                          {visibleColumns.telegram && <th className="py-4.5 sm:py-5 px-6">{isKhmer ? 'Telegram Bot' : 'Telegram Bot'}</th>}
                          {visibleColumns.warranty && <th className="py-4.5 sm:py-5 px-6 text-center">{isKhmer ? 'ការធានា (Warranty)' : 'Warranty (90d)'}</th>}
                          {visibleColumns.status && <th className="py-4.5 sm:py-5 px-6">{isKhmer ? 'ស្ថានភាព' : 'Status'}</th>}
                          {visibleColumns.actions && <th className="py-4.5 sm:py-5 px-6 text-right rounded-r-xl whitespace-nowrap">{isKhmer ? 'សកម្មភាព' : 'Actions'}</th>}
                        </tr>
                      </thead>
                          ...
                          return (
                            ...
                            >
                              ...
                              {visibleColumns.location && (
                                <td className="py-4.5 sm:py-5 px-6 text-slate-600 dark:text-slate-300 max-w-[220px]">
                              ...
                              {visibleColumns.soundboxDevice && (
                                <td className="py-4.5 sm:py-5 px-6 font-mono">
                                  {r.hasDevice ? (
                                    <div className="flex items-center gap-2">
                              ...
                              {visibleColumns.warranty && (
                                <td className="py-4.5 sm:py-5 px-6 text-center whitespace-nowrap">
                                  {r.hasDevice ? (
                                    daysLeft <= 0 ? (
                              ...
                              {visibleColumns.actions && (
                                <td className="py-4.5 sm:py-5 px-6 text-right whitespace-nowrap">
                  ...
                  <div className="md:hidden space-y-6 mt-8">
                    {filteredUnifiedRows.map((r) => {
                      ...
                      return (
                        <div 
                          key={r.rowId}
                          className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/90 dark:border-slate-800 p-4 space-y-3.5 shadow-2xs"
                        >
                          {/* Card Header: Store Name + Status Badge */}
                          <div className="flex items-start justify-between gap-2">
                            <div className="flex items-center gap-2.5">
                              <div className="w-9 h-9 rounded-xl flex items-center justify-center shrink-0 bg-emerald-50 dark:bg-emerald-950/50 text-emerald-600 dark:text-emerald-400 border border-emerald-200/60 dark:border-emerald-800/60">
                                <Store className="w-4 h-4" />
                              </div>
                              <div>
                            ...
                            <div>
                              {r.hasDevice ? (
                                <span className={`px-2.5 py-1 rounded-full text-[10px] font-bold inline-flex items-center gap-1.5 ${
                                  ...
                                  <span>{isOnline ? (isKhmer ? 'ដំណើរការ' : 'Online') : (isKhmer ? 'ក្រៅបណ្តាញ' : 'Offline')}</span>
                                </span>
                              ) : (
                                <span className="px-2.5 py-1 rounded-full text-[10px] font-bold bg-amber-50 text-amber-700 dark:bg-amber-950/60 dark:text-amber-300 border border-amber-200 dark:border-amber-800 inline-flex items-center gap-1">
                                  ...
                                  <span>{isKhmer ? 'គ្មានឧបករណ៍' : 'No Device'}</span>
                                </span>
                              )}
                            </div>
                          </div>
                          ...
                          {/* Location */}
                          <div className="flex items-start gap-1.5 text-xs text-slate-600 dark:text-slate-400 bg-slate-50 dark:bg-slate-800/50 p-2.5 rounded-xl border border-slate-100 dark:border-slate-800">
                            <MapPin className="w-3.5 h-3.5 text-emerald-600 shrink-0 mt-0.5" />
                            <span className="line-clamp-2 leading-relaxed">{r.location || 'Cambodia'}</span>
                          </div>
                            ...
                            <div className="space-y-2 pt-1 border-t border-slate-100 dark:border-slate-800">
                              <div className="flex items-center justify-between text-xs">
                                <div className="flex items-center gap-1.5 font-mono font-bold text-slate-800 dark:text-slate-200">
                                  ...
                                  <span>{r.deviceSn}</span>
                                </div>
                                <span className="px-2 py-0.5 rounded-md text-[10px] font-bold bg-indigo-50 text-indigo-700 dark:bg-indigo-950 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-800">
                                  {r.deviceType || 'Standard'}
                                </span>
                              </div>
                              ...
                              <div className="flex items-center justify-between text-xs text-slate-500 dark:text-slate-400">
                                <div className="flex items-center gap-3">
                                  ...
                                  <span className="inline-flex items-center gap-1 text-[11px]">
                                    ...
                                    <span>{r.signal || 'Good'}</span>
                                  </span>
                                </div>

                                {/* Quick Test & Reboot on mobile */}
                                <div className="flex items-center gap-1.5">
                                  <button
                                    type="button"
                                    disabled={isTesting || !isOnline}
                                    onClick={() => handleRemoteVoiceTest(r.device.id)}
                                    className="p-1.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 rounded-lg text-slate-600 dark:text-slate-300 transition disabled:opacity-40"
                                    title="Remote Voice Test"
                                  >
                                    <Volume2 className={`w-3.5 h-3.5 ${isTesting ? 'animate-bounce text-emerald-500' : ''}`} />
                                  </button>
                                  <button
                                    type="button"
                                    disabled={isRebooting || !isOnline}
                                    onClick={() => handleRemoteReboot(r.device.id)}
                                    className="p-1.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 rounded-lg text-slate-600 dark:text-slate-300 transition disabled:opacity-40"
                                    title="Remote Reboot"
                                  >
                          ...
                          <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-100 dark:border-slate-800">
                            <button
                              type="button"
                              onClick={() => openEditStoreModal(r.store)}
                              className="flex-1 py-2 px-3 text-xs font-semibold text-slate-700 dark:text-slate-200 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 rounded-xl transition flex items-center justify-center gap-1 cursor-pointer"
                            >
                              <Edit3 className="w-3.5 h-3.5 text-slate-400" />
                              <span>{isKhmer ? 'កែសម្រួល' : 'Edit Merchant'}</span>
                            </button>

                            <button
                              type="button"
                              onClick={() => openStoreDetails(r.store)}
                              className="flex-1 py-2 px-3 text-xs font-semibold text-slate-700 dark:text-slate-200 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 rounded-xl transition flex items-center justify-center gap-1 cursor-pointer"
                            >
                            ...
                            {r.hasDevice ? (
                              <button
                                ...
                                className="py-2 px-3 text-xs font-semibold text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/40 rounded-xl transition flex items-center justify-center gap-1 cursor-pointer border border-rose-200/60 dark:border-rose-800/60"
                              >
                                <Unlink className="w-3.5 h-3.5" />
                                <span>{isKhmer ? 'ផ្តាច់' : 'Unlink'}</span>
                              </button>
                            ) : (
                              <button
                                type="button"
            ...
            <div className="space-y-5 sm:space-y-6">
              ...
              <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-xs border border-slate-200/80 dark:border-slate-800 p-5 sm:p-7 lg:p-8 space-y-6">
                ...
                {filteredTransactions.length > 0 ? (
                  <>
                    <div className="hidden md:block my-8 sm:my-10 overflow-x-auto rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xs">
                    <table className="w-full text-left text-sm min-w-[700px]">
                      <thead>
                        <tr className="bg-slate-50 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-800 text-xs font-bold text-slate-500 uppercase tracking-wider">
                          ...
                          <th className="py-4.5 sm:py-5 px-6">{t('bank', 'Bank / Source')}</th>
                          <th className="py-4.5 sm:py-5 px-6">{t('amount', 'Amount')}</th>
                          <th className="py-4.5 sm:py-5 px-6">{t('payer', 'Customer / Payer')}</th>
                          <th className="py-4.5 sm:py-5 px-6">{t('txId', 'Bank Reference ID')}</th>
                          <th className="py-4.5 sm:py-5 px-6">Store Branch</th>
                          <th className="py-4.5 sm:py-5 px-6">{t('device', 'Soundbox SN')}</th>
                          <th className="py-4.5 sm:py-5 px-6">Date & Time</th>
                          <th className="py-4.5 sm:py-5 px-6 text-right">Receipt</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-slate-100 dark:divide-slate-800 text-xs">
                        {filteredTransactions.map((tx) => (
                          ...
                          >
                            ...
                            <td className="py-4.5 sm:py-5 px-6 font-bold text-slate-900 dark:text-white flex items-center gap-2">
                              <span className="w-2 h-2 rounded-full bg-emerald-500"></span>
                              <span>{tx.bank_name || 'Bakong'}</span>
                            </td>
                            <td className="py-4.5 sm:py-5 px-6 font-black text-emerald-600 dark:text-emerald-400 font-mono text-sm">
                              +{tx.currency === 'USD' ? `$${Number(tx.amount).toFixed(2)}` : `៛${Number(tx.amount).toLocaleString()}`}
                            </td>
                            <td className="py-4.5 sm:py-5 px-6 text-slate-700 dark:text-slate-300 font-medium">
                              {tx.payer_name || t('customer', 'Customer')}
                            </td>
                            <td className="py-4.5 sm:py-5 px-6 font-mono text-slate-400">
                              {tx.bank_tx_id || tx.id}
                            </td>
                            <td className="py-4.5 sm:py-5 px-6 font-medium text-slate-800 dark:text-slate-200">
                              {tx.storeName || activeStore?.name}
                            </td>
                            <td className="py-4.5 sm:py-5 px-6 font-mono text-slate-500">
                              {tx.device_sn}
                            </td>
                            <td className="py-4.5 sm:py-5 px-6 text-slate-400">
                  ...
                  <div className="md:hidden space-y-4 mt-6">
                    {filteredTransactions.map((tx) => (
                      <div 
                        ...
                        className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/90 dark:border-slate-800 p-4 space-y-2.5 shadow-2xs cursor-pointer hover:border-emerald-500/50 transition"
                      >
                        ...
                        <div className="flex items-center justify-between text-xs text-slate-600 dark:text-slate-300 pt-1 border-t border-slate-100 dark:border-slate-800">
                          <span className="font-medium">{tx.payer_name || t('customer', 'Customer')}</span>
                          <span className="font-mono text-[11px] text-slate-400">{tx.storeName || activeStore?.name}</span>
                        </div>

                        <div className="flex items-center justify-between text-[11px] text-slate-400 pt-1">
                          <span className="font-mono">SN: {tx.device_sn || 'N/A'}</span>
                          <span>{tx.created_at ? new Date(tx.created_at).toLocaleString([], { dateStyle: 'short', timeStyle: 'short' }) : ''}</span>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            <div className="space-y-4 max-h-[80vh] overflow-y-auto pr-1 text-xs">
              ...
              <div className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-700">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-slate-900 dark:text-white">{r.storeName}</span>
                  {r.hasDevice && (
                    <>
                      <span className="text-slate-300 dark:text-slate-600">/</span>
                      <span className="font-mono font-bold text-indigo-600 dark:text-indigo-400">{r.deviceSn}</span>
                    </>
                  )}
                </div>
                {r.hasDevice && (
              ...
              {/* Hardware Specifications (Non-table fields) */}
              {r.hasDevice ? (
                <>
                  <div className="p-4 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                      ...
                      {/* 4G Firmware Version */}
                      <div className="p-2.5 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200/60 dark:border-slate-700/60">
                        <span className="text-[10px] text-slate-400 font-semibold block">{isKhmer ? 'កំណែ Firmware 4G' : '4G Firmware Version'}</span>
                        <span className="font-mono font-semibold text-slate-900 dark:text-white text-xs mt-0.5 block">{dev?.version_4g || 'v2.4.1-Build402'}</span>
                      </div>

                      {/* WiFi Version / Module */}
                      <div className="p-2.5 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200/60 dark:border-slate-700/60">
                        <span className="text-[10px] text-slate-400 font-semibold block">{isKhmer ? 'ម៉ូឌុល WiFi' : 'WiFi Module / Version'}</span>
                        <span className="font-semibold text-slate-900 dark:text-white text-xs mt-0.5 block">{dev?.version_wifi || 'WiFi 4 (802.11b/g/n)'}</span>
                      </div>

                      {/* Volume Level */}
                      <div className="p-2.5 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200/60 dark:border-slate-700/60">
                        <span className="text-[10px] text-slate-400 font-semibold block">{isKhmer ? 'កម្រិតសំឡេងបច្ចុប្បន្ន' : 'Default Volume'}</span>
                        <div className="flex items-center gap-1.5 mt-0.5 font-bold text-slate-900 dark:text-white">
                          <Volume2 className="w-3.5 h-3.5 text-indigo-500" />
                          <span>{dev?.volume ? `${dev.volume}%` : '80%'}</span>
                        </div>
                      </div>

                      {/* Last Heartbeat / Online Sync */}
                      <div className="p-2.5 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200/60 dark:border-slate-700/60">
                        <span className="text-[10px] text-slate-400 font-semibold block">{isKhmer ? 'ការធ្វើសមកាលកម្មចុងក្រោយ' : 'Last Heartbeat / Sync'}</span>
                        <span className="font-mono text-[11px] text-slate-700 dark:text-slate-300 mt-0.5 block">{dev?.last_heartbeat ? new Date(dev.last_heartbeat).toLocaleString() : 'Recent'}</span>
                      </div>

                      {/* Registered Date */}
                      <div className="p-2.5 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200/60 dark:border-slate-700/60">
                        <span className="text-[10px] text-slate-400 font-semibold block">{isKhmer ? 'កាលបរិច្ឆេទចុះឈ្មោះឧបករណ៍' : 'Device Activated On'}</span>
                        <span className="font-mono text-[11px] text-slate-700 dark:text-slate-300 mt-0.5 block">{dev?.created_at ? new Date(dev.created_at).toLocaleDateString() : '—'}</span>
                      </div>
                    </div>
                  </div>

                  {/* 90-Day Warranty Full Timeline */}
                  <div className="p-4 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 space-y-3">
                    <div className="font-bold text-slate-900 dark:text-white flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-2">
                      <div className="flex items-center gap-2">
                        <ShieldCheck className="w-4 h-4 text-emerald-600" />
                        <span>{isKhmer ? 'កាលវិភាគការធានា (90 ថ្ងៃ)' : '90-Day Warranty Coverage'}</span>
                      </div>
                      <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-bold ${
                        ...
                        {daysLeft > 0 ? `${daysLeft} ${isKhmer ? 'ថ្ងៃនៅសល់' : 'days left'}` : (isKhmer ? 'ផុតកំណត់' : 'Expired')}
                      </span>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                      ...
                      <div className="p-2.5 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200/60 dark:border-slate-700/60">
                        <span className="text-[10px] text-slate-400 font-semibold block">{isKhmer ? 'ថ្ងៃផុតកំណត់ការធានា' : 'Warranty End Date'}</span>
                        <span className="font-mono font-semibold text-slate-900 dark:text-white text-xs mt-0.5 block">{endDate ? endDate.toLocaleDateString() : '—'}</span>
                      </div>
                    </div>
                  </div>
                </>
